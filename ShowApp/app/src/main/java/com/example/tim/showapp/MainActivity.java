...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener, SensorEventListener {
    ...
    private TextView currentX, currentY, currentZ, maxX, maxY, maxZ, Activiteit, Vector;
    private SeekBar progX, progY, progZ;
